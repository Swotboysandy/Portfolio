...
const SectionLabel = ({ icon: Icon, children }: { icon: React.ElementType; children: React.ReactNode }) => (
    <div className="flex items-center gap-2 mb-3">
        <span className="flex items-center justify-center w-7 h-7 rounded-md bg-[#a78bfa]/10 border border-[#a78bfa]/20">
            <Icon className="w-3.5 h-3.5 text-[#7c3aed] dark:text-[#a78bfa]" />
        </span>
                ...
                <FadeContent delay={120}>
                    <div className="mt-7">
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                            <span className="text-[11px] px-2.5 py-1 rounded-full bg-[#a78bfa]/10 text-[#6d28d9] dark:text-[#c4b5fd] border border-[#a78bfa]/20">
                                Personal Build
                            </span>
                ...
                <FadeContent delay={180}>
                    <div className="grid grid-cols-2 gap-3 mt-8">
                        {stats.map((s, i) => (
                            <div
                                key={i}
                                className="rounded-xl border border-neutral-300/70 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/30 px-4 py-3.5"
                            >
                                <div className="text-[#6d28d9] dark:text-[#c4b5fd] text-lg sm:text-xl font-semibold tracking-tight">
                                    {s.value}
                                </div>
                ...
                <div className="mt-12 space-y-10">
                    <Story icon={Wallet} label="The idea" title="It started with two kinds of tired">
                        ...
                        <p>
                            ...
                            <span className="text-neutral-900 dark:text-zinc-200">
                    ...
                    <Story icon={Layers} label="The scraper" title={"Teaching my app to “see”"}>
                        <p>
                            ...
                            <span className="text-neutral-900 dark:text-zinc-200">&ldquo;what&rsquo;s on the home page right now?&rdquo;</span>{" "}
                            and turn the messy answer into clean rows my app could render — Trending, Action, Top 10,
                            the works.
                        </p>
                        <div className="flex gap-3 rounded-xl border border-neutral-300/70 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/30 p-4">
                            <Cookie className="w-5 h-5 text-[#7c3aed] dark:text-[#a78bfa] shrink-0 mt-0.5" />
                            <p className="text-neutral-600 dark:text-zinc-400 text-sm leading-relaxed">
                                The catch: these places don&rsquo;t just let you walk in — every knock needs valid
                                session cookies. So I built a tiny <span className="text-neutral-900 dark:text-zinc-200">cookie butler</span>
                    ...
                    <Story icon={ImageIcon} label="The artwork war" title="Making it look expensive">
                        ...
                        <p>
                            ...
                            <span className="text-neutral-900 dark:text-zinc-200">baked the best ones right into the app</span> so it&rsquo;s
                    ...
                    <FadeContent>
                        <section className="border-t border-neutral-300/70 dark:border-zinc-800 pt-8">
                            ...
                            <h2 className="text-neutral-900 dark:text-white text-xl sm:text-2xl font-semibold mb-3 tracking-tight">
                                Streams that refuse to play anywhere but here
                            </h2>
                            <div className="space-y-3 text-neutral-600 dark:text-zinc-400 text-sm sm:text-[15px] leading-relaxed">
                                <p>
                                    ...
                                    <span className="text-rose-600 dark:text-rose-300/90 font-mono text-[13px]">403</span>. My clever plan
                            ...
                            <div className="mt-5 space-y-2.5">
                                {streamSteps.map((step, i) => (
                                    <div
                                        key={i}
                                        className="relative flex gap-4 rounded-xl border border-neutral-300/70 dark:border-zinc-800 bg-white/40 dark:bg-zinc-900/30 px-4 py-3.5 hover:border-[#a78bfa]/30 transition-colors"
                                    >
                                        <span className="font-mono text-[#7c3aed]/90 dark:text-[#a78bfa]/80 text-sm font-semibold pt-0.5 w-7 shrink-0">
                                            {step.n}
                                        </span>
                                        <div>
                                            <h3 className="text-neutral-900 dark:text-white text-sm font-medium">{step.title}</h3>
                                            <p className="text-neutral-500 dark:text-zinc-500 text-xs sm:text-sm leading-relaxed mt-1">
                                                {step.body}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <p className="text-neutral-600 dark:text-zinc-400 text-sm sm:text-[15px] leading-relaxed mt-5">
                                When that first cartoon finally played —{" "}
                                <span className="text-neutral-900 dark:text-zinc-200">IP-locked link and all</span> — it felt like picking a
                    ...
                    <Story icon={KeyRound} label="The detail nobody documents" title="One byte, hidden in plain sight">
                        ...
                        <p>
                            ...
                            <span className="text-neutral-900 dark:text-zinc-200">version index</span> inside the payload itself, a single
