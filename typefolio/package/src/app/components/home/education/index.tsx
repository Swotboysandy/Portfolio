    ...
    const educationData = [
        {
            ...
            subtitle: "VIT Vellore (in progress)"
        },
        {
            date: "2024",
            title: "BCA (Bachelor of Computer Applications)",
            subtitle: "MGM College of IT & Management, Patna"
        },
        {
            date: "2021",
            title: "Intermediate Science",
            subtitle: "AN College, Patna"
        },
        {
            date: "2019",
            title: "Matriculation",
            subtitle: "Cambridge Public School, Patna"
        }
    ];
                                ...
                                {educationData?.map((item: any, index: any) => (
                                    ...
                                    >
                                        <div className="relative pl-8 sm:pl-0 sm:w-64 sm:text-right sm:pr-16">
                                            <p className="ml-2.5 sm:ml-0 text-base font-normal sm:mb-0 leading-relaxed text-primary">
                                                {item.date}
                                            </p>
                                        ...
                                        <div className="flex flex-col gap-2 flex-1 sm:pl-16 ml-2 sm:ml-0">
                                            ...
                                            <p className="text-primary/80">{item.subtitle}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
