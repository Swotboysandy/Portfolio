...
function buildItems(pool: (ImageInput | string)[], seg: number): DomeItem[] {
    const xCols = Array.from({ length: seg }, (_, i) => -37 + i * 2);
    const evenYs = [-4, -2, 0, 2, 4];
    const oddYs = [-3, -1, 1, 3, 5];

    // We map coordinates roughly to expected grid positions
    ...
    // Create a distributed array of images
